...
//
static RBGStateTable myStateTable[11] = {
    ...
    { /* row 1 */  .blkFlags=mBLOCKSTART, .SPECIAL=mNONE, .efctSound=mSPCL_EFCT_CONTINUOUS|mEFCT_UNIQ_WAITING, .efctLED=mSPCL_EFCT_CONTINUOUS|mEFCT_UNIQ_WAITING, .inputRBG=mINP_TRIG|mINP_BNONE, .storeVal=mNONE, .storeAddr=mNONE, .gotoOnInput=mROW_WINDUP, .gotoWithoutInput=mNONE, .index=mROW_MENU, },
    ...
    { /* row 6 */  .blkFlags=mBLOCKSTART|mBLOCKEND, .SPECIAL=mNONE, .efctSound=mNONE, .efctLED=mNONE, .inputRBG=mNONE, .storeVal=mNONE, .storeAddr=mNONE, .gotoOnInput=mNONE, .gotoWithoutInput=mROW_WINDUP_SOUND, .index=mROW_WINDUP, },
