...
Voice sounds were generated by the eSpeak text-to-speech program version 1.48.04, which can be found at http://espeak.sourceforge.net/
...
* As for many aspects of the RGB, the text-to-speech is semi-automated with StateTable_minimal.xlsx used to control generation.
...
* As for many aspects of the RGB, the LED Patterns are semi-automated with StateTable_minimal.xlsx used to control generation.
